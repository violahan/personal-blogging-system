...
function makeNotificationCard(notificationDetails){
    ...
    notificationCard.setAttribute("id", `notification-${notificationDetails.notificationID}-display-card`)
        notificationCard.innerHTML = `
            <a href="${notificationLinkURL}" onclick="notificationViewed(${notificationDetails.notificationID}, ${notificationDetails.userToBeNotifiedID})">
                <p class="notification-content"><i class="fa fa-caret-right"></i>${notificationDetails.content}</p>
                <p class="notification-time-stamp">${notificationDetails.publishDate}</p>
            </a> 
        `
